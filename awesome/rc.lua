...
fire        = "firefox-aurora"
jd          = terminal .. " -e /home/napster/jd2/JDownloader2"
pcmanfm     = "pcmanfm"
gray = "#474747"
...
theme.wallpaper = "/home/napster/Immagini/bk4.jpg"
local layouts = {
...
mailwidget = lain.widgets.imap({
     ...
     email = "schettini800@gmail.com",
     password = "keyring set mail",
     settings = function()
          mail = ""
          count = ""
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "f",      function() awful.util.spawn("firefox-aurora", false)             end),
    awful.key({ modkey,           }, "n",
        function (c)
